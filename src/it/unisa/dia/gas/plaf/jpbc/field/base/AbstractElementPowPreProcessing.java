 ...
 */
public class AbstractElementPowPreProcessing implements
		ElementPowPreProcessing, Serializable {
	...
	public AbstractElementPowPreProcessing(Field field, int k, byte[] source,
			int offset) {
		this.field = field;
		this.bits = field.getOrder().bitLength();
		this.k = k;
